    ...
    <Layout>
      <div className="bg-white shadow rounded-lg p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">
          Bienvenido, {"User Default"}
        </h1>
        <p className="text-gray-600">
          Sistema de administración de personal de Servicios Médicos SA.
        </p>
        <div className="mt-6 p-6 bg-blue-100 rounded-lg border border-blue-100">
          ...
          <p className="text-gray-700">
            Empresa líder en el campo de los servicios médicos, comprometida
          ...
          <p className="text-gray-700">
            En XYZ, creemos que todos merecen tener acceso a la atención médica
